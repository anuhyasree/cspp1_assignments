...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        caesar_string = ''
        for each_char in self.message_text:
            if each_char in shift_dict:
                caesar_string += shift_dict[each_char]
            else:
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        return (decrypt_message.index(max(decrypt_message, key = self.no_ofvalidwords)) + 1,\
            ...
            # c = 0
            # for words in decrypt_string:
            #   if get_valid_words(words):
            #       c += 1
            # if c > mc:
            #   mc = c
            #   shift_val = each_shift
